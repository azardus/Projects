...
namespace _04_Conditions
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Exo sur l'interpolation de chaine");
            Console.WriteLine("---------------------------------");
            ...
            Console.WriteLine($"sais tu que ton nom : {lastname} contient {lastname.Length} caractères.");

            Console.WriteLine("Bonjour" + name);

            Console.WriteLine("");

            Console.WriteLine("Exo sur ");
            Console.WriteLine("--------");
